...
namespace Testdoan1
{
	public class Manage_Categories
	{
		...
		[Test]
		public void View_CategoryManagementPage_Unauthorized()
		{
			...
			var categoriesLink = wait.Until(ExpectedConditions.ElementToBeClickable(
			   By.XPath("/html/body/div[7]/ul/li[8]")));
		...
		[Test]
		public void View_CategoryManagementPage_With_QueryParams()
		{
			var menuButton = wait.Until(ExpectedConditions.ElementToBeClickable(
					By.XPath("/html/body/main/div/div/section[1]/div/header/div/div[3]/div")));
			menuButton.Click();
		...
		[Test]
		public void Add_Category_Invalid_Title_Empty()
		{
			var menuButton = wait.Until(ExpectedConditions.ElementToBeClickable(
					By.XPath("/html/body/main/div/div/section[1]/div/header/div/div[3]/div")));
			menuButton.Click();
		...
		[Test]
		public void Add_Category_Invalid_Title_Duplicated()
		{
			var menuButton = wait.Until(ExpectedConditions.ElementToBeClickable(
					By.XPath("/html/body/main/div/div/section[1]/div/header/div/div[3]/div")));
			menuButton.Click();
			...
			var title = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("title")));
			title.Clear();
			title.SendKeys("Netlix");
			var Add = wait.Until(ExpectedConditions.ElementToBeClickable(
			  By.XPath("/html/body/main/div/div[2]/button")));
			Add.Click();
		}
		[Test]
		public void Add_Category_Valid()
		{
			var menuButton = wait.Until(ExpectedConditions.ElementToBeClickable(
					By.XPath("/html/body/main/div/div/section[1]/div/header/div/div[3]/div")));
			menuButton.Click();
		...
		[Test]
		public void Edit_Category_Invalid_Title_Empty()
		{
			var menuButton = wait.Until(ExpectedConditions.ElementToBeClickable(
					By.XPath("/html/body/main/div/div/section[1]/div/header/div/div[3]/div")));
			menuButton.Click();
			...
			var edit = wait.Until(ExpectedConditions.ElementToBeClickable(
			   By.XPath("/html/body/main/div/div[5]/div[1]/div[2]/a")));
			edit.Click();
			Thread.Sleep(5000);
			var title = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("title")));
			title.Clear();
		...
		[Test]
		public void Edit_Category_Invalid_Title_Duplicated()
		{
			var menuButton = wait.Until(ExpectedConditions.ElementToBeClickable(
					By.XPath("/html/body/main/div/div/section[1]/div/header/div/div[3]/div")));
			menuButton.Click();
		...
		[Test]
		public void Edit_Category_Valid()
		{
			var menuButton = wait.Until(ExpectedConditions.ElementToBeClickable(
					By.XPath("/html/body/main/div/div/section[1]/div/header/div/div[3]/div")));
			menuButton.Click();
